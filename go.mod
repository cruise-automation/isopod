...
require (
	...
	github.com/cruise-automation/rbacsync v1.0.0
	...
	github.com/stripe/skycfg v0.0.0-20190805025019-bafbc3998017
	...
	sigs.k8s.io/structured-merge-diff v0.0.0-20181214233322-d43a45b8663b // indirect
